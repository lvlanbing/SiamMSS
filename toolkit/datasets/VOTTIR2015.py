...
class VOTTIRVideo(Video):
    ...
    def __init__(self, name, root, video_dir, init_rect, img_names, gt_rect, load_img=False):
        super(VOTTIRVideo, self).__init__(name, root, video_dir,
...
class VOTTIRDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        super(VOTTIRDataset, self).__init__(name, dataset_root)
        ...
        for video in pbar:
            ...
            #                               load_img=load_img)
            self.videos[video] = VOTTIRVideo(video,
                                             dataset_root,
                                             meta_data[video]['video_dir'],
                                             meta_data[video]['init_rect'],
                                             meta_data[video]['img_names'],
