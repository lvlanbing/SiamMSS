...
def get_dict(dir_path):
    ...
    file_lines2 = open(anno_dir_txt + '/camera_motion.label')
    file_lines3 = open(anno_dir_txt + '/motion_change.label')
    file_lines4 = open(anno_dir_txt + '/size_change.label')
    file_lines5 = open(anno_dir_txt + '/occlusion.label')
...
def main():
    ...
    with open('VOTTIR2017.json', 'w') as js:
