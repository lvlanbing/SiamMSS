...
parser.add_argument('--cfg', type=str, default='../experiments/siamsmm_googlenet/config.yaml',
...
def main():
    ...
    if cfg.BACKBONE.PRETRAINED:
        ...
        # backbone_path = r'F:\program\SiamGAT-main\SiamGAT-main\tools\pretrained_models\inception_v3_google-1a9a5a14.pth'
