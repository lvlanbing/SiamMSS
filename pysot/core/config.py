...
__C.META_ARC = "siammss_googlenet"
...
__C.DATASET.GOT = CN()
__C.DATASET.GOT.ROOT = '/home/upup/lv/program/SiamGAT-main/training_dataset/got10k/crop511'
__C.DATASET.GOT.ANNO = '/home/upup/lv/program/SiamGAT-main/training_dataset/got10k/train.json'
...
__C.DATASET.TIR = CN()                                         # TIR dataset path
__C.DATASET.TIR.ROOT = '/media/upup/lv_dataset/crop/tir/crop511'
__C.DATASET.TIR.ANNO = '/media/upup/lv_dataset/crop/tir/train.json'
__C.DATASET.TIR.FRAME_RANGE = 50
__C.DATASET.TIR.NUM_USE = 100000
...
__C.HP_SEARCH.PTBTIR = [0.35, 0.2, 0.45]

__C.HP_SEARCH.LSOTB = [0.35, 0.2, 0.45]

__C.HP_SEARCH.VOTTIR2015 = [0.35, 0.2, 0.45]

__C.HP_SEARCH.VOTTIR2017 = [0.35, 0.2, 0.45]
